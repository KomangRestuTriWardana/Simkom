    ...
    <div>
        <div class="flex items-center gap-3 mb-8 px-2">
            <div class="w-9 h-9 bg-white/10 border border-white/20 rounded-xl flex items-center justify-center">
                <svg class="w-5 h-5 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
            </div>
            <div>
                <h1 class="text-sm font-extrabold tracking-wider uppercase m-0 leading-tight">SIMKOM</h1>
                <span class="text-[9px] text-blue-200 uppercase tracking-widest font-medium">Administrator</span>
            </div>
        </div>
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('admin.pengguna') }}" class="flex items-center gap-3 px-3.5 py-3 rounded-xl text-xs transition-all {{ Route::is('admin.pengguna') ? 'bg-white/10 text-white font-semibold' : 'text-blue-200/80 hover:text-white hover:bg-white/5' }}">
            ...
            <a href="{{ route('admin.profil') }}" class="flex items-center gap-3 px-3.5 py-3 rounded-xl text-xs transition-all {{ Route::is('admin.profil') ? 'bg-white/10 text-white font-semibold' : 'text-blue-200/80 hover:text-white hover:bg-white/5' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-2m-9-3H7m2 0h2m1 0h2m2 0h2"></path></svg>
